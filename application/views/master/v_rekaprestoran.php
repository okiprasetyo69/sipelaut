<section id="content">
     <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 class="header" align="center"> <b>Data Rekapitulasi Jenis Pajak Restoran</b> </h4>
  ...
  <div id="modalobjekpajak" class="modal">
    <div class="modal-content">
      <h4>Tambah Data Rekapitulasi Bill Restoran</h4>
        ...
        <form class="col s12">
          ...
          <div class="row">
            <div class="input-field col s12">
              <div class="row modal-form-row">
                <div class="input-field col s12">
                  <input id="image_url" type="text" class="validate" value="Restoran" readonly="true">
